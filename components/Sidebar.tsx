...
import { LayoutDashboard, MessageSquare, Kanban, Users, CreditCard, Settings, LogOut, Hexagon, UserCircle } from 'lucide-react';
...
const Sidebar: React.FC<Props> = ({ currentView, onChangeView, unreadCount }) => {
  const menuItems = [
    ...
    { id: 'team', label: 'Team Management', icon: UserCircle }, // New Team Nav
  ];
    ...
    <div className="h-full w-64 bg-slate-900 text-white flex flex-col shadow-xl z-50">
      <div className="p-6 flex items-center gap-3">
        ...
        <div>
            ...
            <p className="text-[10px] text-slate-400 font-medium tracking-wider uppercase">Enterprise v4.0</p>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-slate-800">
        <div className="flex items-center gap-3 mt-4 pt-4 border-t border-slate-800">
            ...
            <div className="flex-1 overflow-hidden">
                <p className="text-sm font-semibold truncate">Alex (Super Admin)</p>
                <p className="text-xs text-slate-500 truncate">Total Control</p>
            </div>
